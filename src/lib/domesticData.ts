...
export function getTeamColor(team: string): string {
  const map: Record<string, string> = {
    ...
    // WPL
    "UP Warriorz":                    "bg-purple-500",
    "Gujarat Giants":                 "bg-cyan-600",
    // CPL
...
export const domesticTrophies: DomesticTrophy[] = [
  {
    ...
    firstEdition: 2008,
    frequency: "Annual",
    currentChampion: "Royal Challengers Bangalore",
    currentChampionYear: 2025,
    color: "from-blue-500 to-purple-600",
    winners: [
      { year: 2025, champion: "Royal Challengers Bangalore", runnerUp: "Punjab Kings",              venue: "Eden Gardens, Kolkata" },
  ...
  },
  {
    ...
    league: "India",
    gender: "women",
    description: "India's premier women's T20 franchise competition. Launched in 2023 with five city-based franchises, WPL has quickly become one of the most high-profile women's cricket leagues in the world.",
    firstEdition: 2023,
    frequency: "Annual",
    ...
    winners: [
      { year: 2025, champion: "Mumbai Indians",              runnerUp: "Delhi Capitals",              venue: "Brabourne Stadium, Mumbai",       final: "Mumbai Indians beat Delhi Capitals by 8 wickets" },
      { year: 2024, champion: "Royal Challengers Bangalore", runnerUp: "Delhi Capitals",              venue: "Arun Jaitley Stadium, Delhi",     final: "Royal Challengers Bangalore beat Delhi Capitals by 8 wickets" },
      { year: 2023, champion: "Mumbai Indians",              runnerUp: "Delhi Capitals",              venue: "DY Patil Stadium, Navi Mumbai",   final: "Mumbai Indians beat Delhi Capitals by 7 wickets" },
    ],
  },
  {
    id: "wbbl",
